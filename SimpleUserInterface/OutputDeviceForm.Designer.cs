...
{
    partial class OutputDeviceForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.InfoText.Text = "Тип: Устройство вывода\r\nСценарий поведения: Систма контроля периметра\r\nМесто разм" +
    "ещения: Россия, Москва, Проспект Вернадского, 78";
            // 
            // OutputDeviceForm
            // 
            ...
            this.Name = "OutputDeviceForm";
            this.Text = "OutputDeviceForm";
